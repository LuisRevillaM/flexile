...
// Preset multipliers for quick scenarios
const PRESET_MULTIPLIERS = [1, 10, 50, 100, 500, 1000]; // $100K, $1M, $5M, $10M, $50M, $100M
...
export default function ExitAmountControl({
  ...
  const handleInputFocus = useCallback(() => {
    ...
    const dollars = Number(exitAmountCents) / 100;
  ...
  const handlePresetClick = useCallback((multiplier: number) => {
    const baseAmount = 100_000; // $100K base
      ...
      <div className="space-y-2">
        ...
        <div className="flex gap-2 flex-wrap">
          {PRESET_MULTIPLIERS.map(multiplier => {
            const amount = 100_000 * multiplier; // Base $100K
