    ...
    <DialogPortal data-slot="dialog-portal">
      <DialogOverlay className="grid place-items-center overflow-auto">
        <DialogPrimitive.Content
          ...
          className={cn(
            "bg-background data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 relative z-50 flex max-h-[95vh] min-h-0 w-full max-w-[calc(100%-2rem)] flex-col gap-4 overflow-y-auto rounded-lg p-8 shadow-lg duration-200 sm:max-w-lg md:max-h-[85vh]",
            className,
          )}
          {...props}
        >
